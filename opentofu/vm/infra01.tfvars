...
#     disk_vm_img        = "archlinux" # values: archlinux, debian12, ubuntu22, ubuntu22_minimal, ubuntu24, ubuntu24_minimal
...
disk_size          = 32
disk_vm_datastore  = "local-nvme-vm"
disk_vm_img        = "ubuntu24_minimal" # values: archlinux, debian12, ubuntu22, ubuntu22_minimal, ubuntu24, ubuntu24_minimal
dns_servers        = ["192.168.1.2"] # ["192.168.1.2", "1.1.1.1", "1.0.0.1"]
domain             = "prive.dc.local.hommet.net"
firewall_enabled   = false
hostname           = "infra01"
