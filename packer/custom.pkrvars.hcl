bios_type                = "seabios"
boot_command             = "<wait3>c<wait3>linux /casper/vmlinuz quiet autoinstall net.ifnames=0 ip=dhcp ds='nocloud-net;s=http://{{ .HTTPIP }}:{{ .HTTPPort }}/' <enter><wait5>initrd /casper/initrd<wait5><enter>boot<wait5s><enter>"
boot_wait                = "10s"
bridge_name              = "vmbr0"
...
template_disk_type       = "scsi"
template_nb_core         = "1"
template_nb_cpu          = "1"
template_nb_ram          = "1024"
template_ssh_username    = "jho"
template_storage_pool    = "stoCeph"
